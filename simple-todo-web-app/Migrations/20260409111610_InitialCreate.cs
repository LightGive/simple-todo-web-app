    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskCompletionLogs", x => x.LogId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CharacterStats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PointId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ExercisePoints = table.Column<int>(type: "int", nullable: false),
                    StudyPoints = table.Column<int>(type: "int", nullable: false),
                    HouseworkPoints = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnallocatedPoints", x => x.PointId);
                    table.ForeignKey(
                        name: "FK_UnallocatedPoints_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterStats_UserId",
                table: "CharacterStats",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TaskCompletionLogs_TaskId_CompletedAt",
                table: "TaskCompletionLogs",
                columns: new[] { "TaskId", "CompletedAt" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TaskCompletionLogs_UserId_CompletedAt",
                table: "TaskCompletionLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnallocatedPoints_UserId",
                table: "UnallocatedPoints",
                column: "UserId",
                unique: true);
        }
