...
| --- | ------ | -------------- | -------- | ---- | -------- | -------- | -------------------------------- | ----------------------------- |
| 1   | INP001 | キャラクター名 | text     | ○    | 32文字   | -        | 必須チェック、文字数上限チェック | AspNetUsers.DisplayNameに保存 |
...
| 3   | 運動タスク名   | 必須チェック       | 「運動タスク名を入力してください」               | 送信時             |
| 4   | 運動タスク名   | 文字数上限チェック | 「タスク名は100文字以内で入力してください」      | 送信時             |
| 5   | 勉強タスク名   | 必須チェック       | 「勉強タスク名を入力してください」               | 送信時             |
| 6   | 勉強タスク名   | 文字数上限チェック | 「タスク名は100文字以内で入力してください」      | 送信時             |
| 7   | 家事タスク名   | 必須チェック       | 「家事タスク名を入力してください」               | 送信時             |
| 8   | 家事タスク名   | 文字数上限チェック | 「タスク名は100文字以内で入力してください」      | 送信時             |
...
| --- | ------------ | ---------------------------------------------------------------- | ------------ | -------------- | ---------------------------- |
| 1   | 初期設定登録 | キャラクター名をAspNetUsersに、タスク名をTasksテーブルに保存する | POST         | /setup         | トランザクション内で一括保存。完了後にAspNetUsers.IsInitをtrueに更新する |
...
| No  | テーブル名  | 用途                                    |
| --- | ----------- | --------------------------------------- |
| 1   | AspNetUsers | DisplayName（キャラクター名）の保存     |
| 2   | Tasks       | タスク名の更新（運動・勉強・家事の3件） |
